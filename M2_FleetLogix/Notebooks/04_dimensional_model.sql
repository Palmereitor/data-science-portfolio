...
CREATE OR REPLACE TABLE dim_vehicle (
    vehicle_key INT PRIMARY KEY, -- se usa vehicle_id del origen como surrogate simplificado
...
CREATE OR REPLACE TABLE dim_driver (
    driver_key INT PRIMARY KEY, -- se usa driver_id del origen como surrogate simplificado
...
CREATE OR REPLACE TABLE dim_route (
    route_key INT PRIMARY KEY, -- se usa route_id del origen como surrogate simplificado
